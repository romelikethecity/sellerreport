...
def build_homepage():
    ...
    testimonials = [
        ("Finally a sales-job newsletter that reads job descriptions. "
...
TOOL_ROUNDUPS = [
    ...
    },
    {
        ...
        "faqs": [
            ("Is smooth.AI's data unlimited?", "Not in practice. Higher-tier plans advertise unlimited credits, but there are daily and monthly search caps that aren't always disclosed upfront. You'll also find that \"unlimited\" doesn't mean \"accurate.\" Many contacts returned by smooth have outdated emails or wrong phone numbers, so the raw volume doesn't translate to usable pipeline."),
